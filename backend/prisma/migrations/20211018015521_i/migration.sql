/*
  ...
  - Made the column `fromUserId` on table `UserMail` required. This step will fail if there are existing NULL values in that column.
  - Made the column `toUserId` on table `UserMail` required. This step will fail if there are existing NULL values in that column.
